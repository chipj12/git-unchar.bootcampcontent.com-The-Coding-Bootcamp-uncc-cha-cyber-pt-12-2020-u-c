...
In today's class, students will familiarize themselves with the structure of the course and learn about some of the topics that will be taught. Towards the end of class, students will learn about the CIA triad and complete a group activity. 

Have fun with these activities and be extra encouraging to students today on their first day of class!

### Class Objectives

Students should leave today's class feeling completely welcome, excited, and ready to begin the rigorous journey ahead. Today they will introduce themselves and complete icebreaker activities to set a tone of collaboration and support for the course. 
...
- First off, welcome! And thank you for being a part of our program. Because of instructors and TAs like you, we're helping thousands of students achieve their goals and creative dreams. You've got a long road ahead and plenty of time to make an impact. So buckle in! You're in for a fun ride.

- Today's class is *all* about making the students feel comfortable. This means showing them, from the start, that you and your TAs are committed to their success. Many of your students will be nervous on the first day, so do what you can to engage them as friends. Make sure they know that you will support them through the struggles ahead.

- Because of students' nerves, it's very important that you are *extra* prepared for today's class. Practice the presentation aloud at home. Make sure you understand your presentation and feel comfortable with the transitions. Don't restate the entire lesson from memory, but push yourself to be polished. On the first day, students will be extra aware of your hesitations and extra concerned by signs of unpreparedness. Later, when you've established rapport with your students, you can lighten your preparation a bit. 

- In keeping with the theme of comfort, today's class is also about making students feel comfortable with *each other*. Many of your students will be entering class unsure of what to expect. They might think back to previous learning experiences filled with dull lectures, high-stakes exams, and frequent, nagging feelings of insecurity. It's important they know that this class will be different. As an instructor, your objective is to ensure that the class feels like a vibrant learning community. 
...
- Today's class includes the first slideshow. Feel free to modify the slides to your own style, but be sure to cover the key activities. 

  - **Note**: If you decide to modify the slides, you will need to make a copy.  

- Introductions often take a long time. But they are important for establishing the group dynamic. Feel free to adjust today's lesson plan by removing the last activity if you run out of time. 

- In the next class, students will be setting up their virtual machine environments. Make sure students have Vagrant, VirtualBox and GitBash (Windows) by next class. 
...
- It is recommended to use the slides in the Google Slide web application. Downloading the slides and opening them in PowerPoint may cause formatting errors. 
...
The first 40 minutes of class consist of introductions by the university, program director, student services director and career director. After these introductions, students will introduce themselves. 
...
As you are discussing these slides, look for opportunities to engage students in thoughtful reflection. Encourage students to discuss their opinions and experiences. 

- For example: Ask them to share examples of breaches they've heard about in the news.

  ![01-CyberRise.png](Images/01-CyberRise.png)

#### Defining Cybersecurity

:question: **Ask class**: What comes to mind when you hear the word cybersecurity?

After you've heard a few answers, acknowledge the validity of their responses.

- Using the slides as guidance, explain that cybersecurity isn't really about complicated code and evil hackers, as it is so often portrayed. 
...
### 05. Instructor Do: Course Overview (0:15)
...
- The first two weeks of the program will be largely conceptual. This week, students will learn how to think like a security professional, look at the cybersecurity career landscape, and get an introduction to certifications in the space. 

- Next week, we will look at governance, risk, and compliance. Students will look at security from an organizational perspective via governance, risk, and compliance, and how these topics affect security controls and other decisions.

**Module 2**: System Administration (Unit 3-7)

- Beginning in Unit 3, we will start using technical lab environments to complete activities. Students will get comfortable using the command line and will hone their systems administration skills in the several units that follow. 

- We will cover both Linux and Windows systems, and dive into programming with both Bash and PowerShell. Students will configure and audit servers, and harden them from malicious attacks.
...
- We’ll get hands-on practice analyzing data packets on the wire, investigating network security attacks and hardening, and covering a variety of topics in cryptography. This module will also look at cloud virtualization and security, and students will complete their first project.
...
- Students will gain an understanding of the incident response framework, and how to respond to breaches and incidents. We’ll also spend a unit on forensics, and will use tools to recover deleted data and solve a sample forensics case.
...
- Explain that we will dive into more detail of the use cases of virtual machines (VMs) in the next class.
...
|:-:|
| We will be setting up the virtual machine environments in the next class. Students should install VirtualBox, Vagrant and GitBash before then. Instructions and more details are available in the prework.   |
...
Explain that other units will require the use of multiple virtual machines. Ask class if they can think of reasons why we would need to run multiple virtual machines at the same time. 
...
During Units 12 (Cloud Security) and 13 (Project 1) students will be using personal Azure accounts. These personal accounts are necessary  for students to deploy secure virtual networks to their own personal cloud environments. We do not allow students to deploy networks to Trilogy-owned cloud environments for security reasons.
...
Remind students that they will be spending the second half of the next class getting set up with their local virtual machines. 
...
Let students know that this class will be collaborative and students will spend plenty of time working together on activities. The course is designed to feel like a learning community. This first week is about making students feel comfortable with one another. 
...
Assure students that it’s okay if they are not familiar with using Zoom in a classroom environment, and that you will be modeling good Zoom behaviors throughout the program.
...
**Instructor Note**: Feel free to add to the list of best practices. Remember to update slides if you do.
...
Explain that throughout class, we’ll use techniques to add engagement. Cover some of them below:
...
- We recommend **checking comprehension with class polls** throughout class. At a minimum, do this at the end of every activity review. Class polls provide students with an opportunity to *anonymously* indicate their level of understanding of the previous activity. It will be indicated with this icon: :bar_chart:
  ...
  - Polls can be as simple as the following: 
    ...
    ```
    How comfortable do you feel with <topic>?
...
### 08. Instructor Do: Introduction to First Activity and Breakout Groups (0:05) 
...
Also explain that for each activity, students will be provided the instructions via an "activity file" that they will access on GitLab. 

### 09. Student Do: Assessing Threats (0:15)
...
### 10. Instructor Review: Assessing Threats (0:15)

Spend this time asking different groups to share their answers.  

When reviewing, include specific real-life examples of how these examples can be used in professional applications.

- For example, during a penetration test, a company might purchase 25-50 of these USB drives and drop them in random spots at the target organization's locations. When someone picks one up and plugs it into their computer, it creates a connection and gives remote access to their computer. 
  - Ask if anyone can explain what a penetration test is.


### 11. Defining the CIA Triad (0:10)
...
### 12. Student Do: CIA Triad and Security Scenarios (0:15)
...
### 13. Instructor Review: CIA Triad and Security Scenarios (0:10)
...
### 14.  Instructor Do: Wrapping Up and Looking Ahead (0:05)

Congratulate students on completing the first day of this boot camp! The pace will pick up quickly, and soon they will be completing assignments and projects that showcase a completely new set of skills and comprehension.

Make sure to distribute the student-facing version of the lesson plan: 

- [1.1 Student Guide](StudentGuide.md)

- These students guides will be available for every single class. The slide link should also be provided to students. 

- Depending on your preference, distribute these resources to students before or after class. 

#### Looking Ahead

Explain that next class, we will dive deeper into assessing risk and mitigating threats by evaluating specific attacks and vulnerabilities of users, web applications, servers and databases.  
...
- :warning: **Heads Up**: Students should try to download VirtualBox, Vagrant and Git Bash (Windows) in preparation for the next class. Installation instructions are available in their prework. Additional assistance will be provided in the next class and during office hours.  
